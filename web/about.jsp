...
<html>
    ...
    <body class="bg-white">
        ...
        <div class="buttons mt-4 space-y-4">
            <a href="signup.jsp" class="block bg-blue-700 px-4 py-2 w-2/3 rounded text-center hover:bg-blue-500">Sign Up</a>
            <a href="login.jsp" class="block bg-blue-700 px-4 py-2 w-2/3 rounded text-center hover:bg-blue-500">Login</a>
        </div>
    </div>
    ...
    <section class="bg-blue-100 text-center mx-auto py-12 lg:py-16 px-5 lg:px-24 pb-28">
